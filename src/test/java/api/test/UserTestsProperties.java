...
public class UserTestsProperties {
	...
	public void testUpdateUserByName() {
		...
		Response updatedresponse = UserEndpointsProperties.readUser(this.userpayload.getUsername());
	...
	public void testDeleteUserByName() {
		...
		Response Deleteresponse = UserEndpointsProperties.deleteUser(this.userpayload.getUsername());
